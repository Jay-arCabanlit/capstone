...
$update = $products->editcat($_GET['id']);
                ...
                <div class="row">
                      <div class="col-md-12">
                        <form  action="update.php" method="post">
                          <br>
                          <input type="hidden" name="id" value="<?php echo $update->cat_id; ?>">
                          <input class="form-control"  type="text" name="category" placeholder="Add Category" value="<?php echo $update->cat_name; ?>"> <br>
