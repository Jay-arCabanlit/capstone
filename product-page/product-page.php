				...
				<div class="product product-details clearfix">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<p><p><?php echo $viewDetails->pro_feature1; ?><?php echo $viewDetails->pro_feature2; ?><?php echo $viewDetails->pro_feature3; ?>. <?php echo $viewDetails->pro_feature4; ?> 
          <?php echo $viewDetails->pro_feature5; ?></p></p>
	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
				...
				<!-- Product Single -->
				<?php 
				foreach ($relatedproducts as $relatedview ) 
					{ $pro_details = "
				<div class='col-md-3 col-sm-6 col-xs-6'>
					<div class='product product-single'>
						...
						<div class='product-body'>
							...
							<h2 class='product-name'><a href='#'>".$relatedview->pro_price."</a></h2>
							<div class='product-btns'>
								<button class='main-btn icon-btn'><i class='fa fa-heart'></i></button>
								<button class='main-btn icon-btn'><i class='fa fa-exchange'></i></button>
