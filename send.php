...
<form action="/function/sms.php" method="POST">
	...
	<p style="font-size: 12px; color: red"> Note: Only registered numbers <br>are available for twilio trial! <br> numbers must start with '63'</p>

	<p>Number: </p>
	<input type="text" name="number" maxlength="14" placeholder="number" required><br>
